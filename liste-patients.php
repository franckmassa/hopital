                ...
                <tbody>
                    ...
                    ?>
                        <tr class="table-light">
                            ...
                            <td>
                                <form method="POST" action="?idRemove=<?= $patientsListDetail->id ?>"><input type="submit" value="Supprimer" name="submit" class="btn btn-danger" onclick="return(confirm('Pour supprimer le patient, vous devez supprimer ses rendez-vous ! '));" /></form>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
